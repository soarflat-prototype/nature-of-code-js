...
var Oscillator = function () {
  function Oscillator() {
    ...
    this.angle = new _PVector2.default(0, 0);
    this.velocity = new _PVector2.default((0, _random2.default)(0.01, 0.05) / 100, (0, _random2.default)(0.01, 0.05) / 100);
    this.amplitude = new _PVector2.default((0, _random2.default)(0, this.cw / 2), (0, _random2.default)(0, this.ch / 2));
  }
  ...
  _createClass(Oscillator, [{
    ...
    key: 'draw',
    value: function draw() {
      var x = this.amplitude.x * Math.cos(this.angle.x);
      var y = this.amplitude.y * Math.cos(this.angle.y);
...
var Oscillators = function () {
  function Oscillators() {
    _classCallCheck(this, Oscillators);
...
var oscillators = new Oscillators();
